      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-6 text-gray-500">
              Bharat ke hotels ka smart OS. AI revenue, WhatsApp automation, aur zyada — sab ek jagah.
            </p>
            {/* Social Icons */}
            <div className="flex items-center gap-3">
              {[
                ...
                <a
                  ...
                  className="w-9 h-9 rounded-lg bg-white/5 flex items-center justify-center hover:bg-[#EA580C] hover:text-white transition-all"
                >
                  {social.icon}
                </a>
              ))}
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-600">
            &copy; 2026 HoteloS. Made with ❤️ in India 🇮🇳
          </p>
          <p className="text-xs text-gray-700">
            hotelos.online — India&apos;s Smartest Hotel Management Software
          </p>
        </div>
      </div>
    </footer>
