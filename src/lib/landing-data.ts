...
export const landingPages: Record<string, LandingPageConfig> = {
  "hotel-pms-india": {
    ...
    title: "Hotel Management Software India | Cloud Hotel PMS | Hotelos",
    description:
      "Hotelos is hotel management software for Indian hotels. Manage reservations, front desk, housekeeping, billing, and reporting in one cloud hotel operating system. Ideal for hotels searching hotel software India or hotel management system tools.",
    keywords: [
      "Hotelos",
      "hotelos online",
    ...
    ogTitle: "Hotel Management Software India | Cloud Hotel PMS | Hotelos",
    ogDescription:
      "Manage reservations, front desk, housekeeping, and billing with Hotelos cloud hotel software built for Indian hotels.",
    heroTitle: "Hotel Management Software Built for Indian Hotels",
    heroSubtitle:
      "Hotelos is a complete hotel operating system for reservations, front desk, housekeeping, billing, and reporting.",
    problemTitle:
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Streamlined check-in, check-out, ID scanning, and guest profile management.",
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          "Hotel management software helps hotels handle reservations, front desk, housekeeping, billing, guest communication, and reports in one system.",
      },
      {
        question: "Is Hotelos also a hotel PMS?",
        answer:
          "Yes. Hotelos is a cloud hotel PMS and hotel operating system built for Indian hotels.",
      },
      {
        question: "Can I use Hotelos on mobile?",
        answer:
          "Yes. Hotelos works on desktops, tablets, and smartphones with real-time sync across all devices.",
      },
      {
        question: "Does Hotelos support billing and bookings together?",
        answer:
          "Yes. Hotelos combines hotel booking software and hotel billing software in one platform.",
      },
      {
        question: "Is Hotelos suitable for small and mid-size hotels?",
        answer:
          "Yes. Hotelos is built for independent hotels, guest houses, resorts, and multi-property groups.",
      },
    ],
    ctaTitle: "Ready to Upgrade Your Hotel Operations?",
    ctaSubtitle:
      "Join Indian hotels using Hotelos hotel management software. Free 120-days trial. No credit card required.",
  },
