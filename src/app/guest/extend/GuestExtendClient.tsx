// src/app/guest/extend/GuestExtendClient.tsx
"use client";
...
export default function GuestExtendClient({ token }: { token: string }) {
    ...
    >
      ...
      >
        ...
        >
          ...
          {hotelName && (
            <p style={{ marginTop: 4, fontSize: 13, opacity: 0.85 }}>
        ...
        <div style={{ padding: 24 }}>
          {step === "loading" && (
            <p style={{ textAlign: "center", color: theme.muted, fontSize: 14 }}>Loading…</p>
          )}

          {step === "pick" && (
            <>
              <p style={{ fontSize: 14, color: theme.muted, marginBottom: 16 }}>
                Hi {guestName}! Select how long you'd like to stay:
              </p>
              ...
              <button
                ...
                style={{
                  ...
                  background:
                    selected !== null
                      ? "linear-gradient(135deg, #FF8B5E, #EC5B94)"
                      : "#EEE",
                  color: selected !== null ? "#fff" : "#999",
                  border: "none",
                  borderRadius: 20,
                  padding: "14px 0",
                  fontSize: 15,
                  ...
                  boxShadow:
                    selected !== null ? "0 8px 22px rgba(255,122,69,0.28)" : "none",
                }}
              >
                Request Extension
              </button>
          ...
          {step === "done" && (
            <div style={{ textAlign: "center", paddingBottom: 8 }}>
              ...
              <h2 style={{ fontSize: 20, fontWeight: 700, color: theme.orange }}>
                Request Sent!
              </h2>
              <p style={{ marginTop: 8, fontSize: 14, color: theme.muted }}>
                Our team will confirm availability and reach out shortly. You'll see the update
                here in your chat.
              </p>
            </div>
          )}
