         ...
         <div
          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
             ...
             <h1 className="text-2xl font-bold sm:text-3xl leading-tight">Banquet & Events</h1>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Button
                ...
                icon={<Plus className="h-4 w-4" />}
                className="rounded-2xl border-0 bg-gradient-to-r from-orange-400 via-rose-400 to-fuchsia-400 px-5 py-2.5 text-sm font-bold text-white shadow-[0_12px_30px_-10px_rgba(244,63,94,0.65)] hover:brightness-105"
              >
                New Booking
              </Button>
            </div>
                ...
                {isLoading ? (
                  ...
                  <div className="rounded-[26px] border border-dashed border-orange-200 bg-gradient-to-b from-orange-50/70 to-white py-16 text-center">
                    ...
                    <Button
                      ...
                      icon={<Plus className="h-4 w-4" />}
                      className="mt-2 rounded-2xl border-0 bg-gradient-to-r from-orange-500 via-rose-500 to-fuchsia-500 px-5 py-2.5 text-sm font-bold text-white shadow-[0_12px_30px_-10px_rgba(244,63,94,0.65)] hover:brightness-105"
                      >
